    ...
    <div className="bg-black pt-20">
      ...
      <section className="py-24 bg-[#080808]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <h1 className="section-title mb-6">
            ...
            <span className="text-[#c5a059]">Democratize Business Automation</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="card-dark">
              ...
              <h3 className="text-white font-bold text-xl mb-4">The Problem We Saw</h3>
            ...
            <div className="card-dark">
              <div className="w-8 h-0.5 bg-[#c5a059] mb-5" />
              <h3 className="text-white font-bold text-xl mb-4">Our Solution</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="section-title">These principles guide everything we do</h2>
          </div>
      ...
      <section className="py-24 bg-[#080808]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="section-title">Passionate experts dedicated<br />to your automation success</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="card-dark text-center">
                <div className="w-14 h-14 rounded-full bg-[#c5a059]/10 border border-[#c5a059]/20 flex items-center justify-center mx-auto mb-5">
                  <span className="text-[#c5a059] font-black text-lg">{t.title[0]}</span>
                </div>
          ...
          <div className="mt-10 text-center">
            <Link href="/careers" className="ghost-btn">View Open Positions <ArrowRight className="w-4 h-4" /></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-black border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4">
          <p className="section-label text-center mb-10">Early Impact</p>
          ...
          <div className="text-center">
            <h2 className="text-3xl font-black text-white mb-4">Ready to Start Your Automation Journey?</h2>
            <p className="text-gray-400 mb-8">Join forward-thinking businesses that are already saving time and money with AI automation.</p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/contact" className="gold-btn">Schedule a Free Consultation</Link>
              <Link href="/" className="ghost-btn">View Case Studies</Link>
            </div>
          </div>
        </div>
      </section>
