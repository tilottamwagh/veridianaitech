    ...
    <div className="bg-black pt-20">
      ...
      <section className="py-24 bg-[#080808]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <h1 className="section-title mb-6">
            ...
            <span className="text-[#c5a059]">the Future of AI</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#positions" className="gold-btn">View Open Positions <ArrowRight className="w-4 h-4" /></a>
            <Link href="/about" className="ghost-btn">Learn About Us</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-title text-center mb-14">Why Work at Veridianaitech AI Solutions Inc.?</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="card-dark text-center">
                <div className="w-12 h-12 rounded-full bg-[#c5a059]/10 border border-[#c5a059]/20 flex items-center justify-center mx-auto mb-5">
      ...
      {/* Open Positions */}
      <section id="positions" className="py-24 bg-[#080808]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-14">
            <p className="section-label">Open Positions</p>
            <h2 className="section-title">Find your next opportunity<br />and join our growing team</h2>
          </div>
          ...
          <div className="space-y-6">
            {roles.map((role, i) => (
              <div key={i} className="card-dark">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3 mt-2">
                      <span className="text-xs px-3 py-1 bg-[#c5a059]/10 text-[#c5a059] rounded-full font-medium">{role.dept}</span>
                      <span className="text-xs px-3 py-1 bg-white/5 text-gray-400 rounded-full">{role.location}</span>
                      <span className="text-xs px-3 py-1 bg-white/5 text-gray-400 rounded-full">{role.type}</span>
                    </div>
                  </div>
                </div>
                <p className="text-gray-400 text-sm mb-4">{role.desc}</p>
                <div className="mb-5">
                ...
                <Link href="/contact" className="gold-btn text-sm">Apply Now <ArrowRight className="w-4 h-4" /></Link>
              </div>
            ))}
          </div>

          {/* Don't see a fit */}
          <div className="mt-12 text-center card-dark">
            <h3 className="text-white font-bold text-xl mb-3">Don't See a Perfect Fit?</h3>
            <p className="text-gray-400 text-sm mb-6">We are always looking for talented individuals. Send us your resume and let us know what you are passionate about.</p>
