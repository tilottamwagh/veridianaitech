...
export default function Contact() {
  ...
  return (
    <div className="bg-black pt-20">
      <section className="py-16 bg-[#080808] text-center">
        <p className="section-label">Contact Us</p>
        <h1 className="section-title mb-4">Book a Free Demo</h1>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="card-dark">
              ...
              {[
                ...
                <div key={i} className="flex items-start gap-4 mb-5">
                  <div className="w-10 h-10 rounded-lg bg-[#c5a059]/10 flex items-center justify-center flex-shrink-0">
            ...
            <div className="card-dark">
              <h3 className="text-[#c5a059] font-bold text-sm uppercase tracking-widest mb-4">What to Expect</h3>
          ...
          <div className="card-dark">
            {isSubmitSuccessful ? (
              <div className="flex flex-col items-center justify-center py-16 text-center space-y-5">
                ...
                <h3 className="text-2xl font-black text-white">Details Submitted Successfully!</h3>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                {[
                  ...
                  <div key={field.name}>
                    ...
                    <input
                      ...
                      className="w-full bg-black border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#c5a059]/50 placeholder-gray-600 transition-colors"
                    />
                    {errors[field.name] && (
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-black border border-white/10 rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#c5a059]/50 placeholder-gray-600 resize-none transition-colors"
                  />
                  {errors.message && (
                ...
                <button
                  ...
                  className="gold-btn w-full justify-center py-4 text-base disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
